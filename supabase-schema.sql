...
create policy "jawnix misc income read"
  on public.jawnix_misc_income for select
  to anon
  using (true);

create policy "jawnix misc income write"
  on public.jawnix_misc_income for all
  to anon
  using (true)
  with check (true);
